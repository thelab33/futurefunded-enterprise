    ...
    return {
        ...
        "plans": [
            ...
            },
            {
                "name": "White-label",
                "price": "Custom",
                "body": "Best for schools, nonprofits, and larger organizations that want a fuller branded operating system.",
        ...
        "actions": [
            {"label": "Claim founder setup", "href": "/platform/onboarding"},
            {"label": "View live demo", "href": "/platform/demo"},
        ],
    }

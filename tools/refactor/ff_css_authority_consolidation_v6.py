...
START = "/* FF_AUTHORITY_PROMOTED_FROM_ABOVE_V6_START */"
END = "/* FF_AUTHORITY_PROMOTED_FROM_ABOVE_V6_END */"
...
def main() -> None:
    ...
    if promoted:
        authority_block = (
            START + "\n" +
            "/* Selective canonical fundraiser selectors promoted from ff-above-main-premium.css */\n\n" +
            "\n\n".join(promoted).strip() + "\n" +
            END
        )
    ...
    print("== FF CSS AUTHORITY CONSOLIDATION V6 ==")
